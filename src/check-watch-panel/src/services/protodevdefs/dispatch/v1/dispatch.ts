...
class DispatchCheckRequest$Type extends MessageType<DispatchCheckRequest> {
  constructor() {
    super('dispatch.v1.DispatchCheckRequest', [
      ...
      },
      {
        ...
        kind: 'enum',
        T: () => ['dispatch.v1.DispatchCheckRequest.ResultsSetting', DispatchCheckRequest_ResultsSetting],
      },
  ...
  internalBinaryWrite(message: DispatchCheckRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    for (let i = 0; i < message.resourceIds.length; i++) writer.tag(3, WireType.LengthDelimited).string(message.resourceIds[i]);
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case 2:
          ...
          break;
        default:
          throw new globalThis.Error('unknown map entry field for field dispatch.v1.DispatchCheckResponse.results_by_resource_id');
      }
    }
...
class ResourceCheckResult$Type extends MessageType<ResourceCheckResult> {
  ...
  internalBinaryWrite(message: ResourceCheckResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    for (let i = 0; i < message.missingExprFields.length; i++) writer.tag(3, WireType.LengthDelimited).string(message.missingExprFields[i]);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
  ...
  constructor() {
    super('dispatch.v1.DispatchExpandRequest', [
      ...
      },
      {
        ...
        name: 'expansion_mode',
        kind: 'enum',
        T: () => ['dispatch.v1.DispatchExpandRequest.ExpansionMode', DispatchExpandRequest_ExpansionMode],
      },
    ]);
  }
...
class Cursor$Type extends MessageType<Cursor> {
  ...
  internalBinaryWrite(message: Cursor, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    for (let i = 0; i < message.sections.length; i++) writer.tag(2, WireType.LengthDelimited).string(message.sections[i]);
    /* uint32 dispatch_version = 3; */
    if (message.dispatchVersion !== 0) writer.tag(3, WireType.Varint).uint32(message.dispatchVersion);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class DispatchReachableResourcesRequest$Type extends MessageType<DispatchReachableResourcesRequest> {
  ...
  create(value?: PartialMessage<DispatchReachableResourcesRequest>): DispatchReachableResourcesRequest {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<DispatchReachableResourcesRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(message: DispatchReachableResourcesRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    for (let i = 0; i < message.subjectIds.length; i++) writer.tag(4, WireType.LengthDelimited).string(message.subjectIds[i]);
...
class ReachableResource$Type extends MessageType<ReachableResource> {
  ...
  internalBinaryWrite(message: ReachableResource, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.resourceId !== '') writer.tag(1, WireType.LengthDelimited).string(message.resourceId);
    ...
    for (let i = 0; i < message.forSubjectIds.length; i++) writer.tag(3, WireType.LengthDelimited).string(message.forSubjectIds[i]);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class DispatchReachableResourcesResponse$Type extends MessageType<DispatchReachableResourcesResponse> {
  ...
  create(value?: PartialMessage<DispatchReachableResourcesResponse>): DispatchReachableResourcesResponse {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<DispatchReachableResourcesResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class DispatchLookupResourcesRequest$Type extends MessageType<DispatchLookupResourcesRequest> {
  ...
  create(value?: PartialMessage<DispatchLookupResourcesRequest>): DispatchLookupResourcesRequest {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<DispatchLookupResourcesRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(message: DispatchLookupResourcesRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.context) Struct.internalBinaryWrite(message.context, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
...
class DispatchLookupResourcesResponse$Type extends MessageType<DispatchLookupResourcesResponse> {
  ...
  create(value?: PartialMessage<DispatchLookupResourcesResponse>): DispatchLookupResourcesResponse {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<DispatchLookupResourcesResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class DispatchLookupSubjectsRequest$Type extends MessageType<DispatchLookupSubjectsRequest> {
  ...
  create(value?: PartialMessage<DispatchLookupSubjectsRequest>): DispatchLookupSubjectsRequest {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<DispatchLookupSubjectsRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class DispatchLookupSubjectsResponse$Type extends MessageType<DispatchLookupSubjectsResponse> {
  ...
  create(value?: PartialMessage<DispatchLookupSubjectsResponse>): DispatchLookupSubjectsResponse {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<DispatchLookupSubjectsResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class ResolverMeta$Type extends MessageType<ResolverMeta> {
  ...
  internalBinaryWrite(message: ResolverMeta, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.atRevision !== '') writer.tag(1, WireType.LengthDelimited).string(message.atRevision);
...
class ResponseMeta$Type extends MessageType<ResponseMeta> {
  ...
  internalBinaryWrite(message: ResponseMeta, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.cachedDispatchCount !== 0) writer.tag(3, WireType.Varint).uint32(message.cachedDispatchCount);
...
class DebugInformation$Type extends MessageType<DebugInformation> {
  constructor() {
    super('dispatch.v1.DebugInformation', [{ no: 1, name: 'check', kind: 'message', T: () => CheckDebugTrace }]);
  }
  ...
  internalBinaryWrite(message: DebugInformation, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.check) CheckDebugTrace.internalBinaryWrite(message.check, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class CheckDebugTrace$Type extends MessageType<CheckDebugTrace> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case 2:
          ...
          break;
        default:
          throw new globalThis.Error('unknown map entry field for field dispatch.v1.CheckDebugTrace.results');
      }
    }
    map[key ?? ''] = val ?? ResourceCheckResult.create();
  }
  internalBinaryWrite(message: CheckDebugTrace, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.resourceRelationType !== 0) writer.tag(2, WireType.Varint).int32(message.resourceRelationType);
    ...
    if (message.isCachedResult !== false) writer.tag(4, WireType.Varint).bool(message.isCachedResult);
    ...
    if (message.duration) Duration.internalBinaryWrite(message.duration, writer.tag(6, WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
