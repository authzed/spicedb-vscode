...
export interface IDispatchServiceClient {
   ...
   */
  dispatchCheck(
    input: DispatchCheckRequest,
    options?: RpcOptions,
  ): UnaryCall<DispatchCheckRequest, DispatchCheckResponse>;
  /**
   * @generated from protobuf rpc: DispatchExpand(dispatch.v1.DispatchExpandRequest) returns (dispatch.v1.DispatchExpandResponse);
   */
  dispatchExpand(
    input: DispatchExpandRequest,
    options?: RpcOptions,
  ): UnaryCall<DispatchExpandRequest, DispatchExpandResponse>;
  /**
  ...
  dispatchReachableResources(
    input: DispatchReachableResourcesRequest,
    options?: RpcOptions,
  ): ServerStreamingCall<DispatchReachableResourcesRequest, DispatchReachableResourcesResponse>;
  /**
  ...
  dispatchLookupResources(
    input: DispatchLookupResourcesRequest,
    options?: RpcOptions,
  ): ServerStreamingCall<DispatchLookupResourcesRequest, DispatchLookupResourcesResponse>;
  /**
  ...
  dispatchLookupSubjects(
    input: DispatchLookupSubjectsRequest,
    options?: RpcOptions,
  ): ServerStreamingCall<DispatchLookupSubjectsRequest, DispatchLookupSubjectsResponse>;
}
/**
 * @generated from protobuf service dispatch.v1.DispatchService
 */
export class DispatchServiceClient implements IDispatchServiceClient, ServiceInfo {
  ...
  dispatchCheck(
    ...
    return stackIntercept<DispatchCheckRequest, DispatchCheckResponse>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  dispatchExpand(
    ...
    const method = this.methods[1],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<DispatchExpandRequest, DispatchExpandResponse>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  dispatchReachableResources(
    ...
    const method = this.methods[2],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<DispatchReachableResourcesRequest, DispatchReachableResourcesResponse>(
      "serverStreaming",
      this._transport,
      method,
      opt,
  ...
  dispatchLookupResources(
    ...
    const method = this.methods[3],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<DispatchLookupResourcesRequest, DispatchLookupResourcesResponse>(
      "serverStreaming",
      this._transport,
      method,
      opt,
  ...
  dispatchLookupSubjects(
    ...
    const method = this.methods[4],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<DispatchLookupSubjectsRequest, DispatchLookupSubjectsResponse>(
      "serverStreaming",
      this._transport,
      method,
      opt,
