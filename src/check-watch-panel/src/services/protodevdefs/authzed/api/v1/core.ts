...
class SubjectReference$Type extends MessageType<SubjectReference> {
  ...
  internalBinaryWrite(message: SubjectReference, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.object) ObjectReference.internalBinaryWrite(message.object, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
    /* string optional_relation = 2; */
    if (message.optionalRelation !== '') writer.tag(2, WireType.LengthDelimited).string(message.optionalRelation);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class ObjectReference$Type extends MessageType<ObjectReference> {
  ...
  internalBinaryWrite(message: ObjectReference, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.objectType !== '') writer.tag(1, WireType.LengthDelimited).string(message.objectType);
    /* string object_id = 2; */
    ...
    super('authzed.api.v1.RelationshipUpdate', [
      {
        ...
        name: 'operation',
        kind: 'enum',
        T: () => ['authzed.api.v1.RelationshipUpdate.Operation', RelationshipUpdate_Operation, 'OPERATION_'],
...
class PermissionRelationshipTree$Type extends MessageType<PermissionRelationshipTree> {
  ...
  create(value?: PartialMessage<PermissionRelationshipTree>): PermissionRelationshipTree {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<PermissionRelationshipTree>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(message: PermissionRelationshipTree, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.expandedRelation !== '') writer.tag(4, WireType.LengthDelimited).string(message.expandedRelation);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
    ...
    super('authzed.api.v1.AlgebraicSubjectSet', [
      {
        ...
        name: 'operation',
        kind: 'enum',
        T: () => ['authzed.api.v1.AlgebraicSubjectSet.Operation', AlgebraicSubjectSet_Operation, 'OPERATION_'],
        options: { 'validate.rules': { enum: { definedOnly: true, notIn: [0] } } },
      },
      {
        no: 2,
