...
class Relationship$Type extends MessageType<Relationship> {
  ...
  create(value?: PartialMessage<Relationship>): Relationship {
    ...
    if (value !== undefined) reflectionMergePartial<Relationship>(this, message, value);
    return message;
  }
  internalBinaryRead(
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* authzed.api.v1.ObjectReference resource */ 1:
          message.resource = ObjectReference.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.resource,
        ...
        case /* authzed.api.v1.SubjectReference subject */ 3:
          message.subject = SubjectReference.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.subject,
        ...
        case /* authzed.api.v1.ContextualizedCaveat optional_caveat */ 4:
          message.optionalCaveat = ContextualizedCaveat.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.optionalCaveat,
          );
          break;
        default:
  ...
  internalBinaryWrite(
    ...
    if (message.subject)
      SubjectReference.internalBinaryWrite(
        message.subject,
...
class SubjectReference$Type extends MessageType<SubjectReference> {
  ...
  create(value?: PartialMessage<SubjectReference>): SubjectReference {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<SubjectReference>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* authzed.api.v1.ObjectReference object */ 1:
          message.object = ObjectReference.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.object,
...
class ZedToken$Type extends MessageType<ZedToken> {
  ...
  create(value?: PartialMessage<ZedToken>): ZedToken {
    const message = { token: "" };
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<ZedToken>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class RelationshipUpdate$Type extends MessageType<RelationshipUpdate> {
    ...
    super("authzed.api.v1.RelationshipUpdate", [
      {
        ...
        options: { "validate.rules": { enum: { definedOnly: true, notIn: [0] } } },
      },
      {
        no: 2,
        name: "relationship",
  ...
  create(value?: PartialMessage<RelationshipUpdate>): RelationshipUpdate {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<RelationshipUpdate>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* authzed.api.v1.Relationship relationship */ 2:
          message.relationship = Relationship.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.relationship,
  ...
  internalBinaryWrite(
    ...
    if (message.relationship)
      Relationship.internalBinaryWrite(
        message.relationship,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class PermissionRelationshipTree$Type extends MessageType<PermissionRelationshipTree> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: PermissionRelationshipTree,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* authzed.api.v1.AlgebraicSubjectSet intermediate */ 1:
          message.treeType = {
            oneofKind: "intermediate",
            intermediate: AlgebraicSubjectSet.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.treeType as any).intermediate,
            ),
          };
          break;
        case /* authzed.api.v1.DirectSubjectSet leaf */ 2:
          message.treeType = {
            oneofKind: "leaf",
            leaf: DirectSubjectSet.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.treeType as any).leaf,
            ),
          };
          break;
        case /* authzed.api.v1.ObjectReference expanded_object */ 3:
          message.expandedObject = ObjectReference.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.expandedObject,
          );
          break;
  ...
  internalBinaryWrite(
    ...
    if (message.treeType.oneofKind === "intermediate")
      AlgebraicSubjectSet.internalBinaryWrite(
        message.treeType.intermediate,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
    /* authzed.api.v1.DirectSubjectSet leaf = 2; */
    if (message.treeType.oneofKind === "leaf")
      DirectSubjectSet.internalBinaryWrite(
        message.treeType.leaf,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class AlgebraicSubjectSet$Type extends MessageType<AlgebraicSubjectSet> {
  constructor() {
    super("authzed.api.v1.AlgebraicSubjectSet", [
      ...
      },
      {
        ...
        T: () => PermissionRelationshipTree,
        options: { "validate.rules": { repeated: { items: { message: { required: true } } } } },
      },
    ]);
  }
  create(value?: PartialMessage<AlgebraicSubjectSet>): AlgebraicSubjectSet {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<AlgebraicSubjectSet>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
      ...
      switch (fieldNo) {
        ...
        case /* repeated authzed.api.v1.PermissionRelationshipTree children */ 2:
          message.children.push(
            PermissionRelationshipTree.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
        default:
          let u = options.readUnknownField;
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.children.length; i++)
      PermissionRelationshipTree.internalBinaryWrite(
        message.children[i],
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class DirectSubjectSet$Type extends MessageType<DirectSubjectSet> {
  ...
  create(value?: PartialMessage<DirectSubjectSet>): DirectSubjectSet {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<DirectSubjectSet>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
      ...
      switch (fieldNo) {
        case /* repeated authzed.api.v1.SubjectReference subjects */ 1:
          message.subjects.push(
            SubjectReference.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
        default:
          let u = options.readUnknownField;
