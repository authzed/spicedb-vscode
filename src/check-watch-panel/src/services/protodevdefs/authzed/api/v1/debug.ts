...
class CheckDebugTrace$Type extends MessageType<CheckDebugTrace> {
  ...
  create(value?: PartialMessage<CheckDebugTrace>): CheckDebugTrace {
    const message = {
      ...
      permissionType: 0,
      result: 0,
      resolution: { oneofKind: undefined },
    };
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* authzed.api.v1.CaveatEvalInfo caveat_evaluation_info */ 8:
          message.caveatEvaluationInfo = CaveatEvalInfo.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.caveatEvaluationInfo,
          );
          break;
  ...
  internalBinaryWrite(
    ...
    if (message.caveatEvaluationInfo)
      CaveatEvalInfo.internalBinaryWrite(
        message.caveatEvaluationInfo,
...
class CheckDebugTrace_SubProblems$Type extends MessageType<CheckDebugTrace_SubProblems> {
  ...
  internalBinaryWrite(
    message: CheckDebugTrace_SubProblems,
    writer: IBinaryWriter,
    options: BinaryWriteOptions,
  ): IBinaryWriter {
  ...
  constructor() {
    super("authzed.api.v1.CaveatEvalInfo", [
      { no: 1, name: "expression", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
      {
        ...
        name: "result",
        kind: "enum",
        T: () => ["authzed.api.v1.CaveatEvalInfo.Result", CaveatEvalInfo_Result, "RESULT_"],
      },
