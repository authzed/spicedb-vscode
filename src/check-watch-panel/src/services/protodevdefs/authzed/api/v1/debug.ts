...
class DebugInformation$Type extends MessageType<DebugInformation> {
  ...
  internalBinaryWrite(message: DebugInformation, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.schemaUsed !== '') writer.tag(2, WireType.LengthDelimited).string(message.schemaUsed);
...
class CheckDebugTrace$Type extends MessageType<CheckDebugTrace> {
  constructor() {
    super('authzed.api.v1.CheckDebugTrace', [
      ...
      { no: 2, name: 'permission', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
      {
        ...
        kind: 'enum',
        T: () => ['authzed.api.v1.CheckDebugTrace.PermissionType', CheckDebugTrace_PermissionType, 'PERMISSION_TYPE_'],
      ...
      },
      {
        ...
        name: 'result',
        kind: 'enum',
        T: () => ['authzed.api.v1.CheckDebugTrace.Permissionship', CheckDebugTrace_Permissionship, 'PERMISSIONSHIP_'],
        options: { 'validate.rules': { enum: { definedOnly: true, notIn: [0] } } },
      },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* authzed.api.v1.CheckDebugTrace.SubProblems sub_problems */ 7:
          message.resolution = {
            oneofKind: 'subProblems',
            subProblems: CheckDebugTrace_SubProblems.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.resolution as any).subProblems,
            ),
          };
          break;
        default:
  ...
  internalBinaryWrite(message: CheckDebugTrace, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    /* string permission = 2; */
    if (message.permission !== '') writer.tag(2, WireType.LengthDelimited).string(message.permission);
    /* authzed.api.v1.CheckDebugTrace.PermissionType permission_type = 3; */
    if (message.permissionType !== 0) writer.tag(3, WireType.Varint).int32(message.permissionType);
    ...
    if (message.result !== 0) writer.tag(5, WireType.Varint).int32(message.result);
    ...
    if (message.resolution.oneofKind === 'wasCachedResult') writer.tag(6, WireType.Varint).bool(message.resolution.wasCachedResult);
    /* authzed.api.v1.CheckDebugTrace.SubProblems sub_problems = 7; */
    if (message.resolution.oneofKind === 'subProblems')
      CheckDebugTrace_SubProblems.internalBinaryWrite(
        message.resolution.subProblems,
...
class CheckDebugTrace_SubProblems$Type extends MessageType<CheckDebugTrace_SubProblems> {
  ...
  create(value?: PartialMessage<CheckDebugTrace_SubProblems>): CheckDebugTrace_SubProblems {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<CheckDebugTrace_SubProblems>(this, message, value);
    return message;
  }
  internalBinaryRead(
    ...
    target?: CheckDebugTrace_SubProblems,
...
class CaveatEvalInfo$Type extends MessageType<CaveatEvalInfo> {
  ...
  create(value?: PartialMessage<CaveatEvalInfo>): CaveatEvalInfo {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<CaveatEvalInfo>(this, message, value);
    return message;
  }
  ...
  internalBinaryWrite(message: CaveatEvalInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    /* string expression = 1; */
    if (message.expression !== '') writer.tag(1, WireType.LengthDelimited).string(message.expression);
    /* authzed.api.v1.CaveatEvalInfo.Result result = 2; */
    if (message.result !== 0) writer.tag(2, WireType.Varint).int32(message.result);
    /* google.protobuf.Struct context = 3; */
    if (message.context) Struct.internalBinaryWrite(message.context, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
    ...
    if (message.caveatName !== '') writer.tag(5, WireType.LengthDelimited).string(message.caveatName);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
