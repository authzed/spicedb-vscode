...
class RelationTuple$Type extends MessageType<RelationTuple> {
  constructor() {
    super("core.v1.RelationTuple", [
      ...
      },
      {
        ...
        name: "caveat",
        kind: "message",
        T: () => ContextualizedCaveat,
        options: { "validate.rules": { message: { required: false } } },
      },
    ]);
  }
  create(value?: PartialMessage<RelationTuple>): RelationTuple {
    ...
    if (value !== undefined) reflectionMergePartial<RelationTuple>(this, message, value);
    return message;
  }
  internalBinaryRead(
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* core.v1.ObjectAndRelation resource_and_relation */ 1:
          message.resourceAndRelation = ObjectAndRelation.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.resourceAndRelation,
          );
          break;
        case /* core.v1.ObjectAndRelation subject */ 2:
          message.subject = ObjectAndRelation.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.subject,
        ...
        case /* core.v1.ContextualizedCaveat caveat */ 3:
          message.caveat = ContextualizedCaveat.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.caveat,
  ...
  internalBinaryWrite(
    ...
    if (message.resourceAndRelation)
      ObjectAndRelation.internalBinaryWrite(
        message.resourceAndRelation,
    ...
    if (message.caveat)
      ContextualizedCaveat.internalBinaryWrite(
        message.caveat,
...
class ContextualizedCaveat$Type extends MessageType<ContextualizedCaveat> {
    ...
    super("core.v1.ContextualizedCaveat", [
      {
        ...
        options: {
          "validate.rules": {
            string: { maxBytes: "128", pattern: "^(([a-zA-Z0-9_][a-zA-Z0-9/_|-]{0,127})|\\*)$" },
          },
        },
      },
      {
  ...
  create(value?: PartialMessage<ContextualizedCaveat>): ContextualizedCaveat {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<ContextualizedCaveat>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* google.protobuf.Struct context */ 2:
          message.context = Struct.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.context,
...
class CaveatDefinition$Type extends MessageType<CaveatDefinition> {
  constructor() {
    super("core.v1.CaveatDefinition", [
      ...
      {
        no: 2,
        name: "serialized_expression",
        kind: "scalar",
        T: 12 /*ScalarType.BYTES*/,
        options: { "validate.rules": { bytes: { minLen: "0", maxLen: "4096" } } },
      },
      {
        no: 3,
        ...
        V: { kind: "message", T: () => CaveatTypeReference },
        options: { "validate.rules": { map: { minPairs: "1", maxPairs: "20" } } },
      },
  ...
  create(value?: PartialMessage<CaveatDefinition>): CaveatDefinition {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<CaveatDefinition>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* core.v1.SourcePosition source_position */ 5:
          message.sourcePosition = SourcePosition.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  private binaryReadMap3(
    map: CaveatDefinition["parameterTypes"],
    reader: IBinaryReader,
    options: BinaryReadOptions,
  ): void {
    let len = reader.uint32(),
      end = reader.pos + len,
      key: keyof CaveatDefinition["parameterTypes"] | undefined,
      val: CaveatDefinition["parameterTypes"][any] | undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            "unknown map entry field for field core.v1.CaveatDefinition.parameter_types",
          );
      }
    }
  ...
  internalBinaryWrite(
    ...
    if (message.sourcePosition)
      SourcePosition.internalBinaryWrite(
        message.sourcePosition,
...
class CaveatTypeReference$Type extends MessageType<CaveatTypeReference> {
  constructor() {
    super("core.v1.CaveatTypeReference", [
      { no: 1, name: "type_name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
      {
        ...
        T: () => CaveatTypeReference,
        options: { "validate.rules": { repeated: { minItems: "0", maxItems: "1" } } },
      },
    ]);
  }
  create(value?: PartialMessage<CaveatTypeReference>): CaveatTypeReference {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<CaveatTypeReference>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated core.v1.CaveatTypeReference child_types */ 2:
          message.childTypes.push(
            CaveatTypeReference.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
        default:
          let u = options.readUnknownField;
  ...
  internalBinaryWrite(
    ...
    /* string type_name = 1; */
    if (message.typeName !== "") writer.tag(1, WireType.LengthDelimited).string(message.typeName);
    /* repeated core.v1.CaveatTypeReference child_types = 2; */
    for (let i = 0; i < message.childTypes.length; i++)
      CaveatTypeReference.internalBinaryWrite(
        message.childTypes[i],
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
    let u = options.writeUnknownFields;
...
class ObjectAndRelation$Type extends MessageType<ObjectAndRelation> {
  constructor() {
    super("core.v1.ObjectAndRelation", [
      ...
      },
      {
        ...
        options: {
          "validate.rules": {
            string: { maxBytes: "1024", pattern: "^(([a-zA-Z0-9/_|\\-=+]{1,})|\\*)$" },
          },
        },
      },
      {
        ...
        options: {
          "validate.rules": {
            string: { maxBytes: "64", pattern: "^(\\.\\.\\.|[a-z][a-z0-9_]{1,62}[a-z0-9])$" },
          },
        },
      },
    ]);
  ...
  create(value?: PartialMessage<ObjectAndRelation>): ObjectAndRelation {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<ObjectAndRelation>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    /* string namespace = 1; */
    if (message.namespace !== "") writer.tag(1, WireType.LengthDelimited).string(message.namespace);
    /* string object_id = 2; */
    if (message.objectId !== "") writer.tag(2, WireType.LengthDelimited).string(message.objectId);
    /* string relation = 3; */
    if (message.relation !== "") writer.tag(3, WireType.LengthDelimited).string(message.relation);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class RelationReference$Type extends MessageType<RelationReference> {
  ...
  create(value?: PartialMessage<RelationReference>): RelationReference {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<RelationReference>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Zookie$Type extends MessageType<Zookie> {
    ...
    super("core.v1.Zookie", [
      {
        ...
        kind: "scalar",
        T: 9 /*ScalarType.STRING*/,
        options: { "validate.rules": { string: { minBytes: "1" } } },
      },
    ]);
  }
  create(value?: PartialMessage<Zookie>): Zookie {
    const message = { token: "" };
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<Zookie>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class RelationTupleUpdate$Type extends MessageType<RelationTupleUpdate> {
    ...
    super("core.v1.RelationTupleUpdate", [
      {
        ...
        name: "operation",
        kind: "enum",
        T: () => ["core.v1.RelationTupleUpdate.Operation", RelationTupleUpdate_Operation],
  ...
  create(value?: PartialMessage<RelationTupleUpdate>): RelationTupleUpdate {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<RelationTupleUpdate>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* core.v1.RelationTuple tuple */ 2:
          message.tuple = RelationTuple.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.tuple,
  ...
  internalBinaryWrite(
    ...
    if (message.operation !== 0) writer.tag(1, WireType.Varint).int32(message.operation);
    /* core.v1.RelationTuple tuple = 2; */
    if (message.tuple)
      RelationTuple.internalBinaryWrite(
        message.tuple,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class RelationTupleTreeNode$Type extends MessageType<RelationTupleTreeNode> {
  ...
  create(value?: PartialMessage<RelationTupleTreeNode>): RelationTupleTreeNode {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<RelationTupleTreeNode>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* core.v1.SetOperationUserset intermediate_node */ 1:
          message.nodeType = {
            oneofKind: "intermediateNode",
            intermediateNode: SetOperationUserset.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.nodeType as any).intermediateNode,
            ),
          };
          break;
        case /* core.v1.DirectSubjects leaf_node */ 2:
          message.nodeType = {
            oneofKind: "leafNode",
            leafNode: DirectSubjects.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.nodeType as any).leafNode,
            ),
          };
          break;
        case /* core.v1.ObjectAndRelation expanded */ 3:
          message.expanded = ObjectAndRelation.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.expanded,
        ...
        case /* core.v1.CaveatExpression caveat_expression */ 4:
          message.caveatExpression = CaveatExpression.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    if (message.nodeType.oneofKind === "intermediateNode")
      SetOperationUserset.internalBinaryWrite(
        message.nodeType.intermediateNode,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
    /* core.v1.DirectSubjects leaf_node = 2; */
    if (message.nodeType.oneofKind === "leafNode")
      DirectSubjects.internalBinaryWrite(
        message.nodeType.leafNode,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    if (message.caveatExpression)
      CaveatExpression.internalBinaryWrite(
        message.caveatExpression,
        writer.tag(4, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class SetOperationUserset$Type extends MessageType<SetOperationUserset> {
    ...
    super("core.v1.SetOperationUserset", [
      {
        ...
        name: "operation",
        kind: "enum",
        T: () => ["core.v1.SetOperationUserset.Operation", SetOperationUserset_Operation],
      },
      {
        no: 2,
        name: "child_nodes",
  ...
  create(value?: PartialMessage<SetOperationUserset>): SetOperationUserset {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<SetOperationUserset>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated core.v1.RelationTupleTreeNode child_nodes */ 2:
          message.childNodes.push(
            RelationTupleTreeNode.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
        default:
          let u = options.readUnknownField;
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.childNodes.length; i++)
      RelationTupleTreeNode.internalBinaryWrite(
        message.childNodes[i],
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
    let u = options.writeUnknownFields;
...
class DirectSubject$Type extends MessageType<DirectSubject> {
  ...
  create(value?: PartialMessage<DirectSubject>): DirectSubject {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<DirectSubject>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class DirectSubjects$Type extends MessageType<DirectSubjects> {
  ...
  create(value?: PartialMessage<DirectSubjects>): DirectSubjects {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<DirectSubjects>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.subjects.length; i++)
      DirectSubject.internalBinaryWrite(
        message.subjects[i],
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class NamespaceDefinition$Type extends MessageType<NamespaceDefinition> {
  ...
  create(value?: PartialMessage<NamespaceDefinition>): NamespaceDefinition {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<NamespaceDefinition>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Relation$Type extends MessageType<Relation> {
  ...
  create(value?: PartialMessage<Relation>): Relation {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<Relation>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* core.v1.UsersetRewrite userset_rewrite */ 2:
          message.usersetRewrite = UsersetRewrite.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* core.v1.TypeInformation type_information */ 3:
          message.typeInformation = TypeInformation.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    if (message.usersetRewrite)
      UsersetRewrite.internalBinaryWrite(
        message.usersetRewrite,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    if (message.typeInformation)
      TypeInformation.internalBinaryWrite(
        message.typeInformation,
        writer.tag(3, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class ReachabilityGraph$Type extends MessageType<ReachabilityGraph> {
  constructor() {
    super("core.v1.ReachabilityGraph", [
      {
        no: 1,
        name: "entrypoints_by_subject_type",
        kind: "map",
        K: 9 /*ScalarType.STRING*/,
        V: { kind: "message", T: () => ReachabilityEntrypoints },
      },
      {
        no: 2,
        name: "entrypoints_by_subject_relation",
        kind: "map",
        K: 9 /*ScalarType.STRING*/,
        V: { kind: "message", T: () => ReachabilityEntrypoints },
      },
  ...
  create(value?: PartialMessage<ReachabilityGraph>): ReachabilityGraph {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<ReachabilityGraph>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  private binaryReadMap1(
    map: ReachabilityGraph["entrypointsBySubjectType"],
    reader: IBinaryReader,
    options: BinaryReadOptions,
  ): void {
    let len = reader.uint32(),
      end = reader.pos + len,
      key: keyof ReachabilityGraph["entrypointsBySubjectType"] | undefined,
      val: ReachabilityGraph["entrypointsBySubjectType"][any] | undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            "unknown map entry field for field core.v1.ReachabilityGraph.entrypoints_by_subject_type",
          );
      }
    }
  ...
  private binaryReadMap2(
    map: ReachabilityGraph["entrypointsBySubjectRelation"],
    reader: IBinaryReader,
    options: BinaryReadOptions,
  ): void {
    let len = reader.uint32(),
      end = reader.pos + len,
      key: keyof ReachabilityGraph["entrypointsBySubjectRelation"] | undefined,
      val: ReachabilityGraph["entrypointsBySubjectRelation"][any] | undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            "unknown map entry field for field core.v1.ReachabilityGraph.entrypoints_by_subject_relation",
          );
      }
    }
    map[key ?? ""] = val ?? ReachabilityEntrypoints.create();
  ...
  internalBinaryWrite(
    ...
    for (let k of Object.keys(message.entrypointsBySubjectType)) {
      ...
      writer.tag(2, WireType.LengthDelimited).fork();
      ReachabilityEntrypoints.internalBinaryWrite(
        message.entrypointsBySubjectType[k],
        writer,
        options,
      );
      writer.join().join();
    ...
    for (let k of Object.keys(message.entrypointsBySubjectRelation)) {
      ...
      writer.tag(2, WireType.LengthDelimited).fork();
      ReachabilityEntrypoints.internalBinaryWrite(
        message.entrypointsBySubjectRelation[k],
        writer,
        options,
      );
      writer.join().join();
...
class ReachabilityEntrypoints$Type extends MessageType<ReachabilityEntrypoints> {
  ...
  create(value?: PartialMessage<ReachabilityEntrypoints>): ReachabilityEntrypoints {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<ReachabilityEntrypoints>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: ReachabilityEntrypoints,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated core.v1.ReachabilityEntrypoint entrypoints */ 1:
          message.entrypoints.push(
            ReachabilityEntrypoint.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
        ...
        case /* core.v1.RelationReference subject_relation */ 3:
          message.subjectRelation = RelationReference.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.entrypoints.length; i++)
      ReachabilityEntrypoint.internalBinaryWrite(
        message.entrypoints[i],
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    if (message.subjectRelation)
      RelationReference.internalBinaryWrite(
        message.subjectRelation,
        writer.tag(3, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class ReachabilityEntrypoint$Type extends MessageType<ReachabilityEntrypoint> {
    ...
    super("core.v1.ReachabilityEntrypoint", [
      {
        ...
        kind: "enum",
        T: () => [
          "core.v1.ReachabilityEntrypoint.ReachabilityEntrypointKind",
      ...
      { no: 2, name: "target_relation", kind: "message", T: () => RelationReference },
      {
        ...
        kind: "enum",
        T: () => [
          "core.v1.ReachabilityEntrypoint.EntrypointResultStatus",
          ReachabilityEntrypoint_EntrypointResultStatus,
        ],
      },
  ...
  create(value?: PartialMessage<ReachabilityEntrypoint>): ReachabilityEntrypoint {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<ReachabilityEntrypoint>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* core.v1.RelationReference target_relation */ 2:
          message.targetRelation = RelationReference.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    if (message.resultStatus !== 0) writer.tag(4, WireType.Varint).int32(message.resultStatus);
...
class TypeInformation$Type extends MessageType<TypeInformation> {
  ...
  create(value?: PartialMessage<TypeInformation>): TypeInformation {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<TypeInformation>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated core.v1.AllowedRelation allowed_direct_relations */ 1:
          message.allowedDirectRelations.push(
            AllowedRelation.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
        default:
          let u = options.readUnknownField;
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.allowedDirectRelations.length; i++)
      AllowedRelation.internalBinaryWrite(
        message.allowedDirectRelations[i],
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
    let u = options.writeUnknownFields;
...
class AllowedRelation$Type extends MessageType<AllowedRelation> {
  constructor() {
    super("core.v1.AllowedRelation", [
      ...
      },
      {
        ...
        kind: "message",
        oneof: "relationOrWildcard",
        T: () => AllowedRelation_PublicWildcard,
      },
      { no: 5, name: "source_position", kind: "message", T: () => SourcePosition },
  ...
  create(value?: PartialMessage<AllowedRelation>): AllowedRelation {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<AllowedRelation>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* core.v1.AllowedRelation.PublicWildcard public_wildcard */ 4:
          message.relationOrWildcard = {
            oneofKind: "publicWildcard",
            publicWildcard: AllowedRelation_PublicWildcard.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.relationOrWildcard as any).publicWildcard,
            ),
          };
          break;
        case /* core.v1.SourcePosition source_position */ 5:
        ...
        case /* core.v1.AllowedCaveat required_caveat */ 6:
          message.requiredCaveat = AllowedCaveat.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.requiredCaveat,
          );
          break;
        default:
          let u = options.readUnknownField;
  ...
  internalBinaryWrite(
    ...
    if (message.relationOrWildcard.oneofKind === "publicWildcard")
      AllowedRelation_PublicWildcard.internalBinaryWrite(
        message.relationOrWildcard.publicWildcard,
        writer.tag(4, WireType.LengthDelimited).fork(),
        options,
      ).join();
    /* core.v1.SourcePosition source_position = 5; */
    ...
    if (message.requiredCaveat)
      AllowedCaveat.internalBinaryWrite(
        message.requiredCaveat,
...
class AllowedRelation_PublicWildcard$Type extends MessageType<AllowedRelation_PublicWildcard> {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: AllowedRelation_PublicWildcard,
  ): AllowedRelation_PublicWildcard {
    return target ?? this.create();
  }
  internalBinaryWrite(
    message: AllowedRelation_PublicWildcard,
    writer: IBinaryWriter,
    options: BinaryWriteOptions,
  ): IBinaryWriter {
    let u = options.writeUnknownFields;
...
class AllowedCaveat$Type extends MessageType<AllowedCaveat> {
  ...
  create(value?: PartialMessage<AllowedCaveat>): AllowedCaveat {
    const message = { caveatName: "" };
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<AllowedCaveat>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class UsersetRewrite$Type extends MessageType<UsersetRewrite> {
  ...
  create(value?: PartialMessage<UsersetRewrite>): UsersetRewrite {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<UsersetRewrite>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
      ...
      switch (fieldNo) {
        case /* core.v1.SetOperation union */ 1:
          message.rewriteOperation = {
            oneofKind: "union",
            union: SetOperation.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.rewriteOperation as any).union,
            ),
          };
          break;
        case /* core.v1.SetOperation intersection */ 2:
          message.rewriteOperation = {
            oneofKind: "intersection",
            intersection: SetOperation.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.rewriteOperation as any).intersection,
            ),
          };
          break;
        case /* core.v1.SetOperation exclusion */ 3:
          message.rewriteOperation = {
            oneofKind: "exclusion",
            exclusion: SetOperation.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.rewriteOperation as any).exclusion,
            ),
          };
          break;
        case /* core.v1.SourcePosition source_position */ 4:
  ...
  internalBinaryWrite(
    ...
    if (message.rewriteOperation.oneofKind === "union")
      SetOperation.internalBinaryWrite(
        message.rewriteOperation.union,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    if (message.rewriteOperation.oneofKind === "intersection")
      SetOperation.internalBinaryWrite(
        message.rewriteOperation.intersection,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    if (message.rewriteOperation.oneofKind === "exclusion")
      SetOperation.internalBinaryWrite(
        message.rewriteOperation.exclusion,
        writer.tag(3, WireType.LengthDelimited).fork(),
        options,
      ).join();
    /* core.v1.SourcePosition source_position = 4; */
...
class SetOperation$Type extends MessageType<SetOperation> {
    ...
    super("core.v1.SetOperation", [
      {
        ...
        kind: "message",
        repeat: 1 /*RepeatType.PACKED*/,
        T: () => SetOperation_Child,
        options: {
          "validate.rules": { repeated: { minItems: "1", items: { message: { required: true } } } },
        },
      },
    ]);
  }
  create(value?: PartialMessage<SetOperation>): SetOperation {
    const message = { child: [] };
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<SetOperation>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated core.v1.SetOperation.Child child */ 1:
          message.child.push(
            SetOperation_Child.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
        default:
          let u = options.readUnknownField;
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.child.length; i++)
      SetOperation_Child.internalBinaryWrite(
        message.child[i],
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class SetOperation_Child$Type extends MessageType<SetOperation_Child> {
  ...
  create(value?: PartialMessage<SetOperation_Child>): SetOperation_Child {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<SetOperation_Child>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* core.v1.SetOperation.Child.This _this */ 1:
          message.childType = {
            oneofKind: "This",
            This: SetOperation_Child_This.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.childType as any).This,
            ),
          };
          break;
        case /* core.v1.ComputedUserset computed_userset */ 2:
          message.childType = {
            oneofKind: "computedUserset",
            computedUserset: ComputedUserset.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.childType as any).computedUserset,
            ),
          };
          break;
        case /* core.v1.TupleToUserset tuple_to_userset */ 3:
          message.childType = {
            oneofKind: "tupleToUserset",
            tupleToUserset: TupleToUserset.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.childType as any).tupleToUserset,
            ),
          };
          break;
        case /* core.v1.UsersetRewrite userset_rewrite */ 4:
          message.childType = {
            oneofKind: "usersetRewrite",
            usersetRewrite: UsersetRewrite.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.childType as any).usersetRewrite,
            ),
          };
          break;
        case /* core.v1.SetOperation.Child.Nil _nil */ 6:
          message.childType = {
            oneofKind: "Nil",
            Nil: SetOperation_Child_Nil.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.childType as any).Nil,
            ),
          };
          break;
        case /* core.v1.SourcePosition source_position */ 5:
        ...
        case /* repeated uint32 operation_path */ 7:
          ...
          else message.operationPath.push(reader.uint32());
          break;
        default:
          let u = options.readUnknownField;
          if (u === "throw")
  ...
  internalBinaryWrite(
    ...
    if (message.childType.oneofKind === "usersetRewrite")
      UsersetRewrite.internalBinaryWrite(
        message.childType.usersetRewrite,
        writer.tag(4, WireType.LengthDelimited).fork(),
        options,
      ).join();
    /* core.v1.SetOperation.Child.Nil _nil = 6; */
    if (message.childType.oneofKind === "Nil")
      SetOperation_Child_Nil.internalBinaryWrite(
        message.childType.Nil,
        writer.tag(6, WireType.LengthDelimited).fork(),
        options,
      ).join();
    /* core.v1.SourcePosition source_position = 5; */
...
class SetOperation_Child_This$Type extends MessageType<SetOperation_Child_This> {
  ...
  create(value?: PartialMessage<SetOperation_Child_This>): SetOperation_Child_This {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<SetOperation_Child_This>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: SetOperation_Child_This,
  ): SetOperation_Child_This {
    return target ?? this.create();
  }
  internalBinaryWrite(
    message: SetOperation_Child_This,
    writer: IBinaryWriter,
    options: BinaryWriteOptions,
  ): IBinaryWriter {
    let u = options.writeUnknownFields;
...
class SetOperation_Child_Nil$Type extends MessageType<SetOperation_Child_Nil> {
  ...
  create(value?: PartialMessage<SetOperation_Child_Nil>): SetOperation_Child_Nil {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<SetOperation_Child_Nil>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: SetOperation_Child_Nil,
  ): SetOperation_Child_Nil {
    return target ?? this.create();
  }
  internalBinaryWrite(
    message: SetOperation_Child_Nil,
    writer: IBinaryWriter,
    options: BinaryWriteOptions,
  ): IBinaryWriter {
    let u = options.writeUnknownFields;
...
class TupleToUserset$Type extends MessageType<TupleToUserset> {
  ...
  create(value?: PartialMessage<TupleToUserset>): TupleToUserset {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<TupleToUserset>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* core.v1.TupleToUserset.Tupleset tupleset */ 1:
          message.tupleset = TupleToUserset_Tupleset.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.tupleset,
          ...
          break;
        case /* core.v1.ComputedUserset computed_userset */ 2:
          message.computedUserset = ComputedUserset.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    if (message.tupleset)
      TupleToUserset_Tupleset.internalBinaryWrite(
        message.tupleset,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class TupleToUserset_Tupleset$Type extends MessageType<TupleToUserset_Tupleset> {
  ...
  create(value?: PartialMessage<TupleToUserset_Tupleset>): TupleToUserset_Tupleset {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<TupleToUserset_Tupleset>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: TupleToUserset_Tupleset,
  ): TupleToUserset_Tupleset {
    let message = target ?? this.create(),
      end = reader.pos + length;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
  ...
  internalBinaryWrite(
    message: TupleToUserset_Tupleset,
    writer: IBinaryWriter,
    options: BinaryWriteOptions,
  ): IBinaryWriter {
    /* string relation = 1; */
    if (message.relation !== "") writer.tag(1, WireType.LengthDelimited).string(message.relation);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class ComputedUserset$Type extends MessageType<ComputedUserset> {
    ...
    super("core.v1.ComputedUserset", [
      {
        ...
        name: "object",
        kind: "enum",
        T: () => ["core.v1.ComputedUserset.Object", ComputedUserset_Object],
        options: { "validate.rules": { enum: { definedOnly: true } } },
      },
      {
        no: 2,
  ...
  create(value?: PartialMessage<ComputedUserset>): ComputedUserset {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<ComputedUserset>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    if (message.object !== 0) writer.tag(1, WireType.Varint).int32(message.object);
    /* string relation = 2; */
    if (message.relation !== "") writer.tag(2, WireType.LengthDelimited).string(message.relation);
    /* core.v1.SourcePosition source_position = 3; */
    if (message.sourcePosition)
      SourcePosition.internalBinaryWrite(
        message.sourcePosition,
...
class SourcePosition$Type extends MessageType<SourcePosition> {
  ...
  create(value?: PartialMessage<SourcePosition>): SourcePosition {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<SourcePosition>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class CaveatExpression$Type extends MessageType<CaveatExpression> {
  ...
  create(value?: PartialMessage<CaveatExpression>): CaveatExpression {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<CaveatExpression>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
      ...
      switch (fieldNo) {
        case /* core.v1.CaveatOperation operation */ 1:
          message.operationOrCaveat = {
            oneofKind: "operation",
            operation: CaveatOperation.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.operationOrCaveat as any).operation,
            ),
          };
          break;
        case /* core.v1.ContextualizedCaveat caveat */ 2:
          message.operationOrCaveat = {
            oneofKind: "caveat",
            caveat: ContextualizedCaveat.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.operationOrCaveat as any).caveat,
            ),
          };
          break;
        default:
  ...
  internalBinaryWrite(
    ...
    if (message.operationOrCaveat.oneofKind === "operation")
      CaveatOperation.internalBinaryWrite(
        message.operationOrCaveat.operation,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    if (message.operationOrCaveat.oneofKind === "caveat")
      ContextualizedCaveat.internalBinaryWrite(
        message.operationOrCaveat.caveat,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
    let u = options.writeUnknownFields;
...
class CaveatOperation$Type extends MessageType<CaveatOperation> {
    ...
    super("core.v1.CaveatOperation", [
      {
        ...
        name: "op",
        kind: "enum",
        T: () => ["core.v1.CaveatOperation.Operation", CaveatOperation_Operation],
      },
      {
        no: 2,
        name: "children",
  ...
  create(value?: PartialMessage<CaveatOperation>): CaveatOperation {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<CaveatOperation>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
      ...
      switch (fieldNo) {
        ...
        case /* repeated core.v1.CaveatExpression children */ 2:
          message.children.push(
            CaveatExpression.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
        default:
          let u = options.readUnknownField;
