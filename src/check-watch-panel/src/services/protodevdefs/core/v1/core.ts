...
class ContextualizedCaveat$Type extends MessageType<ContextualizedCaveat> {
    ...
    super('core.v1.ContextualizedCaveat', [
      {
        ...
        options: { 'validate.rules': { string: { maxBytes: '128', pattern: '^(([a-zA-Z0-9_][a-zA-Z0-9/_|-]{0,127})|\\*)$' } } },
      },
  ...
  internalBinaryWrite(message: ContextualizedCaveat, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.caveatName !== '') writer.tag(1, WireType.LengthDelimited).string(message.caveatName);
    /* google.protobuf.Struct context = 2; */
    if (message.context) Struct.internalBinaryWrite(message.context, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class CaveatDefinition$Type extends MessageType<CaveatDefinition> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case 2:
          ...
          break;
        default:
          throw new globalThis.Error('unknown map entry field for field core.v1.CaveatDefinition.parameter_types');
      }
    }
  ...
  internalBinaryWrite(message: CaveatDefinition, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.serializedExpression.length) writer.tag(2, WireType.LengthDelimited).bytes(message.serializedExpression);
    ...
    if (message.metadata) Metadata.internalBinaryWrite(message.metadata, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
    ...
    super('core.v1.ObjectAndRelation', [
      {
        ...
        T: 9 /*ScalarType.STRING*/,
        options: {
          'validate.rules': { string: { maxBytes: '128', pattern: '^([a-z][a-z0-9_]{1,61}[a-z0-9]/)*[a-z][a-z0-9_]{1,62}[a-z0-9]$' } },
        },
      },
      {
        no: 2,
        ...
        kind: 'scalar',
        T: 9 /*ScalarType.STRING*/,
        options: { 'validate.rules': { string: { maxBytes: '1024', pattern: '^(([a-zA-Z0-9/_|\\-=+]{1,})|\\*)$' } } },
      },
      {
        no: 3,
        name: 'relation',
        kind: 'scalar',
        T: 9 /*ScalarType.STRING*/,
        options: { 'validate.rules': { string: { maxBytes: '64', pattern: '^(\\.\\.\\.|[a-z][a-z0-9_]{1,62}[a-z0-9])$' } } },
      },
    ]);
  }
...
class RelationTupleUpdate$Type extends MessageType<RelationTupleUpdate> {
  ...
  internalBinaryWrite(message: RelationTupleUpdate, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.tuple) RelationTuple.internalBinaryWrite(message.tuple, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
          ...
          'validate.rules': {
            repeated: {
              ...
              items: {
                ...
                any: { required: true, in: ['type.googleapis.com/impl.v1.DocComment', 'type.googleapis.com/impl.v1.RelationMetadata'] },
              },
            },
          },
        },
...
class NamespaceDefinition$Type extends MessageType<NamespaceDefinition> {
    ...
    super('core.v1.NamespaceDefinition', [
      {
        ...
        T: 9 /*ScalarType.STRING*/,
        options: {
          'validate.rules': { string: { maxBytes: '128', pattern: '^([a-z][a-z0-9_]{1,62}[a-z0-9]/)*[a-z][a-z0-9_]{1,62}[a-z0-9]$' } },
        },
      },
  ...
  internalBinaryWrite(message: NamespaceDefinition, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.metadata) Metadata.internalBinaryWrite(message.metadata, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
...
class Relation$Type extends MessageType<Relation> {
  ...
  internalBinaryWrite(message: Relation, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.aliasingRelation !== '') writer.tag(6, WireType.LengthDelimited).string(message.aliasingRelation);
    /* string canonical_cache_key = 7; */
    if (message.canonicalCacheKey !== '') writer.tag(7, WireType.LengthDelimited).string(message.canonicalCacheKey);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case 2:
          ...
          break;
        default:
          throw new globalThis.Error('unknown map entry field for field core.v1.ReachabilityGraph.entrypoints_by_subject_type');
      }
    }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case 2:
          ...
          break;
        default:
          throw new globalThis.Error('unknown map entry field for field core.v1.ReachabilityGraph.entrypoints_by_subject_relation');
      }
    }
    map[key ?? ''] = val ?? ReachabilityEntrypoints.create();
  }
...
class ReachabilityEntrypoints$Type extends MessageType<ReachabilityEntrypoints> {
  ...
  internalBinaryWrite(message: ReachabilityEntrypoints, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.subjectType !== '') writer.tag(2, WireType.LengthDelimited).string(message.subjectType);
...
class ReachabilityEntrypoint$Type extends MessageType<ReachabilityEntrypoint> {
    ...
    super('core.v1.ReachabilityEntrypoint', [
      {
        ...
        name: 'kind',
        kind: 'enum',
        T: () => ['core.v1.ReachabilityEntrypoint.ReachabilityEntrypointKind', ReachabilityEntrypoint_ReachabilityEntrypointKind],
      },
      { no: 2, name: 'target_relation', kind: 'message', T: () => RelationReference },
      {
        ...
        name: 'result_status',
        kind: 'enum',
        T: () => ['core.v1.ReachabilityEntrypoint.EntrypointResultStatus', ReachabilityEntrypoint_EntrypointResultStatus],
      },
  ...
  internalBinaryWrite(message: ReachabilityEntrypoint, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.tuplesetRelation !== '') writer.tag(5, WireType.LengthDelimited).string(message.tuplesetRelation);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class AllowedRelation_PublicWildcard$Type extends MessageType<AllowedRelation_PublicWildcard> {
  ...
  create(value?: PartialMessage<AllowedRelation_PublicWildcard>): AllowedRelation_PublicWildcard {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<AllowedRelation_PublicWildcard>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class AllowedCaveat$Type extends MessageType<AllowedCaveat> {
  constructor() {
    super('core.v1.AllowedCaveat', [{ no: 1, name: 'caveat_name', kind: 'scalar', T: 9 /*ScalarType.STRING*/ }]);
  }
    ...
    super('core.v1.SetOperation', [
      {
        ...
        options: { 'validate.rules': { repeated: { minItems: '1', items: { message: { required: true } } } } },
      },
    ]);
  }
...
class SetOperation_Child$Type extends MessageType<SetOperation_Child> {
      ...
      switch (fieldNo) {
        ...
        case /* repeated uint32 operation_path */ 7:
          if (wireType === WireType.LengthDelimited)
            for (let e = reader.int32() + reader.pos; reader.pos < e; ) message.operationPath.push(reader.uint32());
  ...
  internalBinaryWrite(message: SetOperation_Child, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.operationPath.length) {
      ...
      for (let i = 0; i < message.operationPath.length; i++) writer.uint32(message.operationPath[i]);
      writer.join();
    }
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
...
class SourcePosition$Type extends MessageType<SourcePosition> {
  ...
  internalBinaryWrite(message: SourcePosition, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.zeroIndexedLineNumber !== '0') writer.tag(1, WireType.Varint).uint64(message.zeroIndexedLineNumber);
    /* uint64 zero_indexed_column_position = 2; */
    if (message.zeroIndexedColumnPosition !== '0') writer.tag(2, WireType.Varint).uint64(message.zeroIndexedColumnPosition);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
