...
class DeveloperRequest$Type extends MessageType<DeveloperRequest> {
  ...
  create(value?: PartialMessage<DeveloperRequest>): DeveloperRequest {
    ...
    if (value !== undefined) reflectionMergePartial<DeveloperRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* developer.v1.RequestContext context */ 1:
          message.context = RequestContext.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.context,
  ...
  internalBinaryWrite(
    ...
    if (message.context)
      RequestContext.internalBinaryWrite(
        message.context,
...
class DeveloperResponse$Type extends MessageType<DeveloperResponse> {
  ...
  create(value?: PartialMessage<DeveloperResponse>): DeveloperResponse {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<DeveloperResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* developer.v1.DeveloperErrors developer_errors */ 2:
          message.developerErrors = DeveloperErrors.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* developer.v1.OperationsResults operations_results */ 3:
          message.operationsResults = OperationsResults.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    if (message.developerErrors)
      DeveloperErrors.internalBinaryWrite(
        message.developerErrors,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    if (message.operationsResults)
      OperationsResults.internalBinaryWrite(
        message.operationsResults,
...
class RequestContext$Type extends MessageType<RequestContext> {
  ...
  create(value?: PartialMessage<RequestContext>): RequestContext {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<RequestContext>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
      ...
      switch (fieldNo) {
        ...
        case /* repeated core.v1.RelationTuple relationships */ 2:
          message.relationships.push(
            RelationTuple.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
        default:
          let u = options.readUnknownField;
  ...
  internalBinaryWrite(
    ...
    /* string schema = 1; */
    if (message.schema !== "") writer.tag(1, WireType.LengthDelimited).string(message.schema);
...
class Operation$Type extends MessageType<Operation> {
  ...
  create(value?: PartialMessage<Operation>): Operation {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<Operation>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* developer.v1.CheckOperationParameters check_parameters */ 1:
          message.checkParameters = CheckOperationParameters.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* developer.v1.RunAssertionsParameters assertions_parameters */ 2:
          message.assertionsParameters = RunAssertionsParameters.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.assertionsParameters,
          );
          break;
        case /* developer.v1.RunValidationParameters validation_parameters */ 3:
          message.validationParameters = RunValidationParameters.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.validationParameters,
          );
          break;
        case /* developer.v1.FormatSchemaParameters format_schema_parameters */ 4:
          message.formatSchemaParameters = FormatSchemaParameters.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    if (message.checkParameters)
      CheckOperationParameters.internalBinaryWrite(
        message.checkParameters,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    if (message.assertionsParameters)
      RunAssertionsParameters.internalBinaryWrite(
        message.assertionsParameters,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    if (message.validationParameters)
      RunValidationParameters.internalBinaryWrite(
        message.validationParameters,
        writer.tag(3, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    if (message.formatSchemaParameters)
      FormatSchemaParameters.internalBinaryWrite(
        message.formatSchemaParameters,
...
class OperationsResults$Type extends MessageType<OperationsResults> {
    ...
    super("developer.v1.OperationsResults", [
      {
        ...
        V: { kind: "message", T: () => OperationResult },
      },
    ]);
  }
  create(value?: PartialMessage<OperationsResults>): OperationsResults {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<OperationsResults>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  private binaryReadMap1(
    map: OperationsResults["results"],
    reader: IBinaryReader,
    options: BinaryReadOptions,
  ): void {
    let len = reader.uint32(),
      end = reader.pos + len,
      key: keyof OperationsResults["results"] | undefined,
      val: OperationsResults["results"][any] | undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            "unknown map entry field for field developer.v1.OperationsResults.results",
          );
      }
    }
...
class OperationResult$Type extends MessageType<OperationResult> {
  ...
  create(value?: PartialMessage<OperationResult>): OperationResult {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<OperationResult>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* developer.v1.CheckOperationsResult check_result */ 1:
          message.checkResult = CheckOperationsResult.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.checkResult,
        ...
        case /* developer.v1.RunAssertionsResult assertions_result */ 2:
          message.assertionsResult = RunAssertionsResult.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.assertionsResult,
          );
          break;
        case /* developer.v1.RunValidationResult validation_result */ 3:
          message.validationResult = RunValidationResult.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* developer.v1.FormatSchemaResult format_schema_result */ 4:
          message.formatSchemaResult = FormatSchemaResult.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    if (message.checkResult)
      CheckOperationsResult.internalBinaryWrite(
        message.checkResult,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    if (message.assertionsResult)
      RunAssertionsResult.internalBinaryWrite(
        message.assertionsResult,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    if (message.validationResult)
      RunValidationResult.internalBinaryWrite(
        message.validationResult,
        writer.tag(3, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    if (message.formatSchemaResult)
      FormatSchemaResult.internalBinaryWrite(
        message.formatSchemaResult,
        writer.tag(4, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class DeveloperError$Type extends MessageType<DeveloperError> {
  constructor() {
    super("developer.v1.DeveloperError", [
      ...
      { no: 3, name: "column", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
      {
        ...
        name: "source",
        kind: "enum",
        T: () => ["developer.v1.DeveloperError.Source", DeveloperError_Source],
      },
      {
        no: 5,
        name: "kind",
        kind: "enum",
        T: () => ["developer.v1.DeveloperError.ErrorKind", DeveloperError_ErrorKind],
      },
      {
        no: 6,
        name: "path",
      ...
      {
        no: 9,
        name: "check_resolved_debug_information",
        kind: "message",
        T: () => DebugInformation$,
      },
    ]);
  ...
  create(value?: PartialMessage<DeveloperError>): DeveloperError {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<DeveloperError>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* dispatch.v1.DebugInformation check_debug_information */ 8:
          message.checkDebugInformation = DebugInformation.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.checkDebugInformation,
          );
          break;
        case /* authzed.api.v1.DebugInformation check_resolved_debug_information */ 9:
          message.checkResolvedDebugInformation = DebugInformation$.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.checkResolvedDebugInformation,
          );
          break;
        default:
          let u = options.readUnknownField;
  ...
  internalBinaryWrite(
    ...
    /* uint32 line = 2; */
    if (message.line !== 0) writer.tag(2, WireType.Varint).uint32(message.line);
    /* uint32 column = 3; */
    if (message.column !== 0) writer.tag(3, WireType.Varint).uint32(message.column);
    /* developer.v1.DeveloperError.Source source = 4; */
    if (message.source !== 0) writer.tag(4, WireType.Varint).int32(message.source);
    /* developer.v1.DeveloperError.ErrorKind kind = 5; */
    if (message.kind !== 0) writer.tag(5, WireType.Varint).int32(message.kind);
    /* repeated string path = 6; */
    for (let i = 0; i < message.path.length; i++)
      writer.tag(6, WireType.LengthDelimited).string(message.path[i]);
    /* string context = 7; */
    if (message.context !== "") writer.tag(7, WireType.LengthDelimited).string(message.context);
...
class DeveloperErrors$Type extends MessageType<DeveloperErrors> {
  ...
  create(value?: PartialMessage<DeveloperErrors>): DeveloperErrors {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<DeveloperErrors>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
      ...
      switch (fieldNo) {
        case /* repeated developer.v1.DeveloperError input_errors */ 1:
          message.inputErrors.push(
            DeveloperError.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
        default:
          let u = options.readUnknownField;
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.inputErrors.length; i++)
      DeveloperError.internalBinaryWrite(
...
class CheckOperationParameters$Type extends MessageType<CheckOperationParameters> {
  ...
  create(value?: PartialMessage<CheckOperationParameters>): CheckOperationParameters {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<CheckOperationParameters>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: CheckOperationParameters,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* core.v1.ObjectAndRelation resource */ 1:
          message.resource = ObjectAndRelation.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.resource,
        ...
        case /* google.protobuf.Struct caveat_context */ 3:
          message.caveatContext = Struct.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.caveatContext,
          );
          break;
        default:
          let u = options.readUnknownField;
...
class CheckOperationsResult$Type extends MessageType<CheckOperationsResult> {
    ...
    super("developer.v1.CheckOperationsResult", [
      {
        ...
        kind: "enum",
        T: () => [
          "developer.v1.CheckOperationsResult.Membership",
  ...
  create(value?: PartialMessage<CheckOperationsResult>): CheckOperationsResult {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<CheckOperationsResult>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* developer.v1.DeveloperError check_error */ 2:
          message.checkError = DeveloperError.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.checkError,
        ...
        case /* dispatch.v1.DebugInformation debug_information */ 3:
          message.debugInformation = DebugInformation.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* developer.v1.PartialCaveatInfo partial_caveat_info */ 4:
          message.partialCaveatInfo = PartialCaveatInfo.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* authzed.api.v1.DebugInformation resolved_debug_information */ 5:
          message.resolvedDebugInformation = DebugInformation$.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.resolvedDebugInformation,
          );
          break;
        default:
          let u = options.readUnknownField;
  ...
  internalBinaryWrite(
    ...
    if (message.partialCaveatInfo)
      PartialCaveatInfo.internalBinaryWrite(
        message.partialCaveatInfo,
        writer.tag(4, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class PartialCaveatInfo$Type extends MessageType<PartialCaveatInfo> {
    ...
    super("developer.v1.PartialCaveatInfo", [
      {
        ...
        repeat: 2 /*RepeatType.UNPACKED*/,
        T: 9 /*ScalarType.STRING*/,
        options: { "validate.rules": { repeated: { minItems: "1" } } },
      },
    ]);
  }
  create(value?: PartialMessage<PartialCaveatInfo>): PartialCaveatInfo {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<PartialCaveatInfo>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class RunAssertionsParameters$Type extends MessageType<RunAssertionsParameters> {
  ...
  create(value?: PartialMessage<RunAssertionsParameters>): RunAssertionsParameters {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<RunAssertionsParameters>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: RunAssertionsParameters,
...
class RunAssertionsResult$Type extends MessageType<RunAssertionsResult> {
  ...
  create(value?: PartialMessage<RunAssertionsResult>): RunAssertionsResult {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<RunAssertionsResult>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* developer.v1.DeveloperError input_error */ 1:
          message.inputError = DeveloperError.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.inputError,
...
class RunValidationParameters$Type extends MessageType<RunValidationParameters> {
  ...
  create(value?: PartialMessage<RunValidationParameters>): RunValidationParameters {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<RunValidationParameters>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: RunValidationParameters,
...
class RunValidationResult$Type extends MessageType<RunValidationResult> {
  ...
  create(value?: PartialMessage<RunValidationResult>): RunValidationResult {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<RunValidationResult>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class FormatSchemaParameters$Type extends MessageType<FormatSchemaParameters> {
  ...
  create(value?: PartialMessage<FormatSchemaParameters>): FormatSchemaParameters {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<FormatSchemaParameters>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class FormatSchemaResult$Type extends MessageType<FormatSchemaResult> {
  ...
  create(value?: PartialMessage<FormatSchemaResult>): FormatSchemaResult {
    ...
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
    if (value !== undefined) reflectionMergePartial<FormatSchemaResult>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
