...
class DeveloperResponse$Type extends MessageType<DeveloperResponse> {
  ...
  internalBinaryWrite(message: DeveloperResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.internalError !== '') writer.tag(1, WireType.LengthDelimited).string(message.internalError);
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case 2:
          ...
          break;
        default:
          throw new globalThis.Error('unknown map entry field for field developer.v1.OperationsResults.results');
      }
    }
...
class DeveloperError$Type extends MessageType<DeveloperError> {
  ...
  internalBinaryWrite(message: DeveloperError, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    for (let i = 0; i < message.path.length; i++) writer.tag(6, WireType.LengthDelimited).string(message.path[i]);
    /* string context = 7; */
    ...
    super('developer.v1.CheckOperationsResult', [
      {
        ...
        name: 'membership',
        kind: 'enum',
        T: () => ['developer.v1.CheckOperationsResult.Membership', CheckOperationsResult_Membership],
      },
...
class RunAssertionsParameters$Type extends MessageType<RunAssertionsParameters> {
  constructor() {
    super('developer.v1.RunAssertionsParameters', [{ no: 1, name: 'assertions_yaml', kind: 'scalar', T: 9 /*ScalarType.STRING*/ }]);
  }
  ...
  internalBinaryWrite(message: RunAssertionsParameters, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.assertionsYaml !== '') writer.tag(1, WireType.LengthDelimited).string(message.assertionsYaml);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class RunValidationParameters$Type extends MessageType<RunValidationParameters> {
  constructor() {
    super('developer.v1.RunValidationParameters', [{ no: 1, name: 'validation_yaml', kind: 'scalar', T: 9 /*ScalarType.STRING*/ }]);
  }
  ...
  internalBinaryWrite(message: RunValidationParameters, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.validationYaml !== '') writer.tag(1, WireType.LengthDelimited).string(message.validationYaml);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class RunValidationResult$Type extends MessageType<RunValidationResult> {
  ...
  internalBinaryWrite(message: RunValidationResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.updatedValidationYaml !== '') writer.tag(2, WireType.LengthDelimited).string(message.updatedValidationYaml);
...
class FormatSchemaResult$Type extends MessageType<FormatSchemaResult> {
  constructor() {
    super('developer.v1.FormatSchemaResult', [{ no: 1, name: 'formatted_schema', kind: 'scalar', T: 9 /*ScalarType.STRING*/ }]);
  }
  ...
  internalBinaryWrite(message: FormatSchemaResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.formattedSchema !== '') writer.tag(1, WireType.LengthDelimited).string(message.formattedSchema);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
