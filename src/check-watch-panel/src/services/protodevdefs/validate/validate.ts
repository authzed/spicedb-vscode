...
class FieldRules$Type extends MessageType<FieldRules> {
  ...
  internalBinaryWrite(message: FieldRules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.message) MessageRules.internalBinaryWrite(message.message, writer.tag(17, WireType.LengthDelimited).fork(), options).join();
...
class FloatRules$Type extends MessageType<FloatRules> {
  ...
  internalBinaryWrite(message: FloatRules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    /* optional float lt = 2; */
    if (message.lt !== undefined) writer.tag(2, WireType.Bit32).float(message.lt);
    /* optional float lte = 3; */
    if (message.lte !== undefined) writer.tag(3, WireType.Bit32).float(message.lte);
    /* optional float gt = 4; */
    if (message.gt !== undefined) writer.tag(4, WireType.Bit32).float(message.gt);
    /* optional float gte = 5; */
    if (message.gte !== undefined) writer.tag(5, WireType.Bit32).float(message.gte);
    /* repeated float in = 6; */
    ...
    if (message.ignoreEmpty !== undefined) writer.tag(8, WireType.Varint).bool(message.ignoreEmpty);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class DoubleRules$Type extends MessageType<DoubleRules> {
  ...
  internalBinaryWrite(message: DoubleRules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.lt !== undefined) writer.tag(2, WireType.Bit64).double(message.lt);
    /* optional double lte = 3; */
    if (message.lte !== undefined) writer.tag(3, WireType.Bit64).double(message.lte);
    /* optional double gt = 4; */
    if (message.gt !== undefined) writer.tag(4, WireType.Bit64).double(message.gt);
    /* optional double gte = 5; */
    if (message.gte !== undefined) writer.tag(5, WireType.Bit64).double(message.gte);
...
class Int32Rules$Type extends MessageType<Int32Rules> {
  ...
  internalBinaryWrite(message: Int32Rules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    /* optional int32 lt = 2; */
    if (message.lt !== undefined) writer.tag(2, WireType.Varint).int32(message.lt);
    /* optional int32 lte = 3; */
    if (message.lte !== undefined) writer.tag(3, WireType.Varint).int32(message.lte);
    /* optional int32 gt = 4; */
    if (message.gt !== undefined) writer.tag(4, WireType.Varint).int32(message.gt);
    /* optional int32 gte = 5; */
    if (message.gte !== undefined) writer.tag(5, WireType.Varint).int32(message.gte);
    /* repeated int32 in = 6; */
...
class Int64Rules$Type extends MessageType<Int64Rules> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated int64 in */ 6:
          if (wireType === WireType.LengthDelimited)
            for (let e = reader.int32() + reader.pos; reader.pos < e; ) message.in.push(reader.int64().toString());
          else message.in.push(reader.int64().toString());
          break;
        case /* repeated int64 not_in */ 7:
          if (wireType === WireType.LengthDelimited)
            for (let e = reader.int32() + reader.pos; reader.pos < e; ) message.notIn.push(reader.int64().toString());
          else message.notIn.push(reader.int64().toString());
          break;
        case /* optional bool ignore_empty */ 8:
          message.ignoreEmpty = reader.bool();
          break;
  ...
  internalBinaryWrite(message: Int64Rules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    /* optional int64 lt = 2; */
    if (message.lt !== undefined) writer.tag(2, WireType.Varint).int64(message.lt);
    /* optional int64 lte = 3; */
    if (message.lte !== undefined) writer.tag(3, WireType.Varint).int64(message.lte);
    /* optional int64 gt = 4; */
    if (message.gt !== undefined) writer.tag(4, WireType.Varint).int64(message.gt);
    /* optional int64 gte = 5; */
    if (message.gte !== undefined) writer.tag(5, WireType.Varint).int64(message.gte);
    /* repeated int64 in = 6; */
...
class UInt32Rules$Type extends MessageType<UInt32Rules> {
  ...
  internalBinaryWrite(message: UInt32Rules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.lt !== undefined) writer.tag(2, WireType.Varint).uint32(message.lt);
    /* optional uint32 lte = 3; */
    if (message.lte !== undefined) writer.tag(3, WireType.Varint).uint32(message.lte);
    /* optional uint32 gt = 4; */
    if (message.gt !== undefined) writer.tag(4, WireType.Varint).uint32(message.gt);
    /* optional uint32 gte = 5; */
    if (message.gte !== undefined) writer.tag(5, WireType.Varint).uint32(message.gte);
...
class UInt64Rules$Type extends MessageType<UInt64Rules> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated uint64 in */ 6:
          if (wireType === WireType.LengthDelimited)
            for (let e = reader.int32() + reader.pos; reader.pos < e; ) message.in.push(reader.uint64().toString());
          else message.in.push(reader.uint64().toString());
          break;
        case /* repeated uint64 not_in */ 7:
          if (wireType === WireType.LengthDelimited)
            for (let e = reader.int32() + reader.pos; reader.pos < e; ) message.notIn.push(reader.uint64().toString());
          else message.notIn.push(reader.uint64().toString());
          break;
        case /* optional bool ignore_empty */ 8:
          message.ignoreEmpty = reader.bool();
          break;
  ...
  internalBinaryWrite(message: UInt64Rules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.lt !== undefined) writer.tag(2, WireType.Varint).uint64(message.lt);
    /* optional uint64 lte = 3; */
    if (message.lte !== undefined) writer.tag(3, WireType.Varint).uint64(message.lte);
    /* optional uint64 gt = 4; */
    if (message.gt !== undefined) writer.tag(4, WireType.Varint).uint64(message.gt);
    /* optional uint64 gte = 5; */
    if (message.gte !== undefined) writer.tag(5, WireType.Varint).uint64(message.gte);
...
class SInt32Rules$Type extends MessageType<SInt32Rules> {
  ...
  internalBinaryWrite(message: SInt32Rules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.lt !== undefined) writer.tag(2, WireType.Varint).sint32(message.lt);
    /* optional sint32 lte = 3; */
    if (message.lte !== undefined) writer.tag(3, WireType.Varint).sint32(message.lte);
    /* optional sint32 gt = 4; */
    if (message.gt !== undefined) writer.tag(4, WireType.Varint).sint32(message.gt);
    /* optional sint32 gte = 5; */
    if (message.gte !== undefined) writer.tag(5, WireType.Varint).sint32(message.gte);
...
class SInt64Rules$Type extends MessageType<SInt64Rules> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated sint64 in */ 6:
          if (wireType === WireType.LengthDelimited)
            for (let e = reader.int32() + reader.pos; reader.pos < e; ) message.in.push(reader.sint64().toString());
          else message.in.push(reader.sint64().toString());
          break;
        case /* repeated sint64 not_in */ 7:
          if (wireType === WireType.LengthDelimited)
            for (let e = reader.int32() + reader.pos; reader.pos < e; ) message.notIn.push(reader.sint64().toString());
  ...
  internalBinaryWrite(message: SInt64Rules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.lt !== undefined) writer.tag(2, WireType.Varint).sint64(message.lt);
    /* optional sint64 lte = 3; */
    if (message.lte !== undefined) writer.tag(3, WireType.Varint).sint64(message.lte);
    /* optional sint64 gt = 4; */
    if (message.gt !== undefined) writer.tag(4, WireType.Varint).sint64(message.gt);
    /* optional sint64 gte = 5; */
    if (message.gte !== undefined) writer.tag(5, WireType.Varint).sint64(message.gte);
...
class Fixed32Rules$Type extends MessageType<Fixed32Rules> {
  ...
  internalBinaryWrite(message: Fixed32Rules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.lt !== undefined) writer.tag(2, WireType.Bit32).fixed32(message.lt);
    /* optional fixed32 lte = 3; */
    if (message.lte !== undefined) writer.tag(3, WireType.Bit32).fixed32(message.lte);
    /* optional fixed32 gt = 4; */
    if (message.gt !== undefined) writer.tag(4, WireType.Bit32).fixed32(message.gt);
    /* optional fixed32 gte = 5; */
    if (message.gte !== undefined) writer.tag(5, WireType.Bit32).fixed32(message.gte);
...
class Fixed64Rules$Type extends MessageType<Fixed64Rules> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated fixed64 in */ 6:
          if (wireType === WireType.LengthDelimited)
            for (let e = reader.int32() + reader.pos; reader.pos < e; ) message.in.push(reader.fixed64().toString());
          else message.in.push(reader.fixed64().toString());
          break;
        case /* repeated fixed64 not_in */ 7:
          if (wireType === WireType.LengthDelimited)
            for (let e = reader.int32() + reader.pos; reader.pos < e; ) message.notIn.push(reader.fixed64().toString());
          else message.notIn.push(reader.fixed64().toString());
          break;
        case /* optional bool ignore_empty */ 8:
          message.ignoreEmpty = reader.bool();
          break;
  ...
  internalBinaryWrite(message: Fixed64Rules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.lt !== undefined) writer.tag(2, WireType.Bit64).fixed64(message.lt);
    /* optional fixed64 lte = 3; */
    if (message.lte !== undefined) writer.tag(3, WireType.Bit64).fixed64(message.lte);
    /* optional fixed64 gt = 4; */
    if (message.gt !== undefined) writer.tag(4, WireType.Bit64).fixed64(message.gt);
    /* optional fixed64 gte = 5; */
    if (message.gte !== undefined) writer.tag(5, WireType.Bit64).fixed64(message.gte);
...
class SFixed32Rules$Type extends MessageType<SFixed32Rules> {
  ...
  internalBinaryWrite(message: SFixed32Rules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.lt !== undefined) writer.tag(2, WireType.Bit32).sfixed32(message.lt);
    /* optional sfixed32 lte = 3; */
    if (message.lte !== undefined) writer.tag(3, WireType.Bit32).sfixed32(message.lte);
    /* optional sfixed32 gt = 4; */
    if (message.gt !== undefined) writer.tag(4, WireType.Bit32).sfixed32(message.gt);
    /* optional sfixed32 gte = 5; */
    if (message.gte !== undefined) writer.tag(5, WireType.Bit32).sfixed32(message.gte);
...
class SFixed64Rules$Type extends MessageType<SFixed64Rules> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated sfixed64 in */ 6:
          if (wireType === WireType.LengthDelimited)
            for (let e = reader.int32() + reader.pos; reader.pos < e; ) message.in.push(reader.sfixed64().toString());
          else message.in.push(reader.sfixed64().toString());
          break;
        case /* repeated sfixed64 not_in */ 7:
          if (wireType === WireType.LengthDelimited)
            for (let e = reader.int32() + reader.pos; reader.pos < e; ) message.notIn.push(reader.sfixed64().toString());
          else message.notIn.push(reader.sfixed64().toString());
          break;
        case /* optional bool ignore_empty */ 8:
          message.ignoreEmpty = reader.bool();
          break;
  ...
  internalBinaryWrite(message: SFixed64Rules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.lt !== undefined) writer.tag(2, WireType.Bit64).sfixed64(message.lt);
    /* optional sfixed64 lte = 3; */
    if (message.lte !== undefined) writer.tag(3, WireType.Bit64).sfixed64(message.lte);
    /* optional sfixed64 gt = 4; */
    if (message.gt !== undefined) writer.tag(4, WireType.Bit64).sfixed64(message.gt);
    /* optional sfixed64 gte = 5; */
    if (message.gte !== undefined) writer.tag(5, WireType.Bit64).sfixed64(message.gte);
...
class BoolRules$Type extends MessageType<BoolRules> {
  constructor() {
    super('validate.BoolRules', [{ no: 1, name: 'const', kind: 'scalar', opt: true, T: 8 /*ScalarType.BOOL*/ }]);
  }
...
class StringRules$Type extends MessageType<StringRules> {
  ...
  internalBinaryWrite(message: StringRules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.wellKnown.oneofKind === 'wellKnownRegex') writer.tag(24, WireType.Varint).int32(message.wellKnown.wellKnownRegex);
    /* optional bool strict = 25; */
    if (message.strict !== undefined) writer.tag(25, WireType.Varint).bool(message.strict);
    /* optional bool ignore_empty = 26; */
    if (message.ignoreEmpty !== undefined) writer.tag(26, WireType.Varint).bool(message.ignoreEmpty);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class BytesRules$Type extends MessageType<BytesRules> {
  ...
  internalBinaryWrite(message: BytesRules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.ignoreEmpty !== undefined) writer.tag(14, WireType.Varint).bool(message.ignoreEmpty);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class MessageRules$Type extends MessageType<MessageRules> {
  ...
  internalBinaryWrite(message: MessageRules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.skip !== undefined) writer.tag(1, WireType.Varint).bool(message.skip);
...
class RepeatedRules$Type extends MessageType<RepeatedRules> {
  ...
  internalBinaryWrite(message: RepeatedRules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.items) FieldRules.internalBinaryWrite(message.items, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
    /* optional bool ignore_empty = 5; */
    if (message.ignoreEmpty !== undefined) writer.tag(5, WireType.Varint).bool(message.ignoreEmpty);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class MapRules$Type extends MessageType<MapRules> {
  ...
  internalBinaryWrite(message: MapRules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.noSparse !== undefined) writer.tag(3, WireType.Varint).bool(message.noSparse);
    /* optional validate.FieldRules keys = 4; */
    if (message.keys) FieldRules.internalBinaryWrite(message.keys, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
    /* optional validate.FieldRules values = 5; */
    if (message.values) FieldRules.internalBinaryWrite(message.values, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
    /* optional bool ignore_empty = 6; */
    if (message.ignoreEmpty !== undefined) writer.tag(6, WireType.Varint).bool(message.ignoreEmpty);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class DurationRules$Type extends MessageType<DurationRules> {
  ...
  internalBinaryWrite(message: DurationRules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.const) Duration.internalBinaryWrite(message.const, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
    /* optional google.protobuf.Duration lt = 3; */
    if (message.lt) Duration.internalBinaryWrite(message.lt, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
    /* optional google.protobuf.Duration lte = 4; */
    if (message.lte) Duration.internalBinaryWrite(message.lte, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
    /* optional google.protobuf.Duration gt = 5; */
    if (message.gt) Duration.internalBinaryWrite(message.gt, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
    /* optional google.protobuf.Duration gte = 6; */
    if (message.gte) Duration.internalBinaryWrite(message.gte, writer.tag(6, WireType.LengthDelimited).fork(), options).join();
...
class TimestampRules$Type extends MessageType<TimestampRules> {
  ...
  internalBinaryWrite(message: TimestampRules, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.const) Timestamp.internalBinaryWrite(message.const, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
    /* optional google.protobuf.Timestamp lt = 3; */
    if (message.lt) Timestamp.internalBinaryWrite(message.lt, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
    /* optional google.protobuf.Timestamp lte = 4; */
    if (message.lte) Timestamp.internalBinaryWrite(message.lte, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
    /* optional google.protobuf.Timestamp gt = 5; */
    if (message.gt) Timestamp.internalBinaryWrite(message.gt, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
    /* optional google.protobuf.Timestamp gte = 6; */
    if (message.gte) Timestamp.internalBinaryWrite(message.gte, writer.tag(6, WireType.LengthDelimited).fork(), options).join();
    /* optional bool lt_now = 7; */
    if (message.ltNow !== undefined) writer.tag(7, WireType.Varint).bool(message.ltNow);
    /* optional bool gt_now = 8; */
    if (message.gtNow !== undefined) writer.tag(8, WireType.Varint).bool(message.gtNow);
    /* optional google.protobuf.Duration within = 9; */
    if (message.within) Duration.internalBinaryWrite(message.within, writer.tag(9, WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
